...
import { Loader2, Eye, EyeOff, Shield, KeyRound, CheckCircle2, Phone, ShieldCheck, ArrowLeft, MessageSquare, UserPlus } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
          ...
          <div className="pt-4 border-t border-slate-100 space-y-4 text-center">
            <div className="text-sm">
              ...
              <Link href="/hr/register" className="font-semibold text-primary hover:underline inline-flex items-center gap-1">
